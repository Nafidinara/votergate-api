 ...
 *     description: Only admins can create other rooms.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: get all rooms with some query params.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   get:
 *     summary: Get a room
 *     description: Logged in rooms can fetch only their own room information.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in rooms can only update their own information.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in rooms can delete only themselves.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
